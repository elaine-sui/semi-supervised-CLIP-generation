...
import sys
sys.path.append('/pasteur/u/esui/repos/semi-supervised-CLIP-generation/src/parse_data/Imagebind')
sys.path.append('/pasteur/u/esui/repos/semi-supervised-CLIP-generation/src/parse_data')
...
def main():
    out_paths = [f"{DATA_ROOT}/data/coco/oscar_split_imagebind_{split}.pkl" for split in splits2]
