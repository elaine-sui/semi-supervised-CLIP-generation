...
TEXT_EMBED_MEAN = '/pasteur/u/esui/data/coco/imagebind_normalized_text_embed_mean.pkl'
IMAGE_EMBED_MEAN = '/pasteur/u/esui/data/coco/imagebind_normalized_image_embed_mean.pkl'

def main():
    data_path =  '/pasteur/u/esui/data/coco/oscar_split_imagebind_train.pkl'
