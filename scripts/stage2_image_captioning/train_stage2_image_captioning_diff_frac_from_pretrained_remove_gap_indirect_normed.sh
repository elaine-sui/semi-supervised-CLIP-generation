...
do
    ...
    python3 run.py --config configs/coco_stage2_image_captioning_from_unimodal_restval.yaml --train --test --sample_frac 0.01 --random_seed $seed --remove_mean --normalize_prefix

    # 5% of pre-training data size
    python3 run.py --config configs/coco_stage2_image_captioning_from_unimodal_restval.yaml --train --test --sample_frac 0.05 --random_seed $seed --remove_mean --normalize_prefix
